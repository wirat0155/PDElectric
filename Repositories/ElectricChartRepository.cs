...
{
    public class ElectricChartRepository
    {
        private readonly DapperService _dapperService;

        public ElectricChartRepository(DapperService dapperService)
        {
        ...
        public async Task<IEnumerable<ProductionDataModel>> GetProductionDataAsync(DateTime startDate, DateTime endDate)
        {
            try
            {
                ...
                */
                ...
                string createTableQuery = @"
                    ...
                    END";
                await _dapperService.Execute("NM", createTableQuery);
                ...
                if (isHistorical)
                {
                    ...
                    var cachedData = await _dapperService.Query<ProductionDataModel>("NM", cacheQuery, new { txt_StartDate = startDate, txt_EndDate = endDate });
                ...
                var liveData = await _dapperService.Query<ProductionDataModel>("NM", query, new { txt_StartDate = startDate, txt_EndDate = endDate });
                ...
                if (isHistorical && liveData.Any())
                {
                    ...
                    await _dapperService.Execute("NM", deleteQuery, new { txt_StartDate = startDate, txt_EndDate = endDate });
                    ...
                    await _dapperService.Execute("NM", insertQuery, liveData);
                }
            ...
            {
                throw new Exception($"Error retrieving production data: {ex.Message}", ex);
            }
        }
    }
}
